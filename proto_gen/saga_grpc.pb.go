...
const (
	SagaService_StartSaga_FullMethodName = "/saga.SagaService/StartSaga"
)
...
type SagaServiceClient interface {
	StartSaga(ctx context.Context, in *StartSagaRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *sagaServiceClient) StartSaga(ctx context.Context, in *StartSagaRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type SagaServiceServer interface {
	StartSaga(context.Context, *StartSagaRequest) (*emptypb.Empty, error)
...
func (UnimplementedSagaServiceServer) StartSaga(context.Context, *StartSagaRequest) (*emptypb.Empty, error) {
...
var SagaService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto_files/saga.proto",
}
